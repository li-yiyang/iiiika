...
var l292=internals.make_lisp_string('iiiika');
var l293=internals.make_lisp_string('click');
var l294=internals.make_lisp_string('query-name-sets');
var l295=internals.make_lisp_string('query-name-kbd-container');
var l296=internals.make_lisp_string('query-name-input');
var l297=internals.make_lisp_string('query-name-message');
var l298=internals.make_lisp_string('defrule-sets');
var l299=internals.make_lisp_string('defrule-kbd-container');
var l300=internals.make_lisp_string('defrule-input');
var l301=internals.make_lisp_string('defrule-to');
...
(function(){var v570=[];
try{var v571=l24.fvalue(internals.pv,l292);
var v572=v571;
l44.stack.push(l44.value);
v570.push(l44);
l44.value=v572;
return l47.fvalue(internals.pv,v571,l293,(function JSCL_USER_NIL(values,v573){internals.checkArgs(arguments.length-1,1);
var v574=this;
return l5.value;
}));
}finally{v570.forEach((function(S){S.value=S.stack.pop();
}));
}})();
l114.fvalue(internals.pv,l294,l295,l296,l297);
return l114.fvalue(values,l298,l299,l300,l301);
})();
});
FUNC.fname='MAIN';
